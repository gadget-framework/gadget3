  ...
  return out;
    ...
    while (true) {
        ...
        }
        {
            ...
            auto growth_delta_w = (fish__growth_lastcalc == std::floor(cur_step_size*12) ? fish__growth_w : (fish__growth_w = (g3a_grow_vec_rotate((fish__midlen).pow(fish__wbeta), 4 + 1) - g3a_grow_vec_extrude((fish__midlen).pow(fish__wbeta), 4 + 1))*fish__walpha));
