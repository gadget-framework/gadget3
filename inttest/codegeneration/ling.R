structure(function (param) 
{
    ...
    cdist_sumofsquares_ldist_lln_obs__keepnum <- array(1L, dim = c(length = 35L, time = 92L), dimnames = list(length = c("20:24", "24:28", "28:32", "32:36", "36:40", "40:44", "44:48", "48:52", "52:56", "56:60", "60:64", "64:68", "68:72", "72:76", "76:80", "80:84", "84:88", "88:92", "92:96", "96:100", "100:104", "104:108", "108:112", "112:116", "116:120", "120:124", "124:128", "128:132", "132:136", "136:140", "140:144", "144:148", "148:152", "152:156", "156:Inf"), time = c("1994-04", "1995-01", "1995-03", 
        "1995-04", "1996-01", "1996-03", "1996-04", "1997-01", "1997-02", "1997-03", "1997-04", "1998-01", "1998-02", "1998-03", "1998-04", "1999-01", "1999-02", "1999-03", "1999-04", "2000-01", "2000-02", "2000-03", "2000-04", "2001-01", "2001-03", "2001-04", "2002-01", "2002-02", "2002-03", "2002-04", "2003-01", "2003-02", "2003-03", "2003-04", "2004-01", "2004-02", "2004-03", "2004-04", "2005-01", "2005-02", "2005-03", "2005-04", "2006-01", "2006-02", "2006-03", "2006-04", "2007-01", "2007-02", 
        "2007-03", "2007-04", "2008-01", "2008-02", "2008-03", "2008-04", "2009-01", "2009-02", "2009-03", "2009-04", "2010-01", "2010-02", "2010-03", "2010-04", "2011-01", "2011-02", "2011-03", "2011-04", "2012-01", "2012-02", "2012-03", "2012-04", "2013-01", "2013-02", "2013-03", "2013-04", "2014-01", "2014-02", "2014-03", "2014-04", "2015-01", "2015-02", "2015-03", "2015-04", "2016-01", "2016-02", "2016-03", "2016-04", "2017-02", "2017-03", "2017-04", "2018-01", "2018-02", "2018-03")))
        ...
        }
        {
            comment("g3l_catchdistribution_sumofsquares: Compare cdist_sumofsquares_ldist_lln_model to cdist_sumofsquares_ldist_lln_obs")
            {
                ...
                if (cdist_sumofsquares_ldist_lln_obs__time_idx >= (1L)) {
                  cur_cdist_nll <- sum(cdist_sumofsquares_ldist_lln_obs__keepnum[, cdist_sumofsquares_ldist_lln_obs__time_idx] * (cdist_sumofsquares_ldist_lln_model__num[]/avoid_zero(sum(cdist_sumofsquares_ldist_lln_model__num[])) - cdist_sumofsquares_ldist_lln_obs__num[, cdist_sumofsquares_ldist_lln_obs__time_idx]/avoid_zero(sum(cdist_sumofsquares_ldist_lln_obs__num[, cdist_sumofsquares_ldist_lln_obs__time_idx])))^2)
                  {
