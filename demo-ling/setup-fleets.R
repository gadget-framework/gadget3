...
fleet_actions <-
  list(
    ...
    bmt %>%
      g3a_predate_totalfleet(list(ling_imm, ling_mat),
                             suitabilities = list(
                               ling_imm = g3_suitability_exponentiall50(~0.01*exp(g3_param('ling.bmt.alpha')),
                                                                        gadget3:::f_substitute(l50,list(fleet_l50=~g3_param('ling.bmt.l50')))),
                               ling_mat = g3_suitability_exponentiall50(~0.01*exp(g3_param('ling.bmt.alpha')),
                                                                        gadget3:::f_substitute(l50,list(fleet_l50=~g3_param('ling.bmt.l50'))))),
    ...
    gil %>%
      g3a_predate_totalfleet(list(ling_imm, ling_mat),
                             suitabilities = list(
                               ling_imm = g3_suitability_exponentiall50(~0.01*exp(g3_param('ling.gil.alpha')),
                                                                        gadget3:::f_substitute(l50,list(fleet_l50=~g3_param('ling.gil.l50')))),
                               ling_mat = g3_suitability_exponentiall50(~0.01*exp(g3_param('ling.gil.alpha')),
                                                                        gadget3:::f_substitute(l50,list(fleet_l50=~g3_param('ling.gil.l50'))))),
    ...
    igfs %>%
      g3a_predate_totalfleet(list(ling_imm, ling_mat),
                             suitabilities = list(
                               ling_imm = g3_suitability_exponentiall50(~0.01*exp(g3_param('ling.igfs.alpha')),
                                                                        gadget3:::f_substitute(l50,list(fleet_l50=~g3_param('ling.igfs.l50')))),
                               ling_mat = g3_suitability_exponentiall50(~0.01*exp(g3_param('ling.igfs.alpha')),
                                                                        gadget3:::f_substitute(l50,list(fleet_l50=~g3_param('ling.igfs.l50'))))),
