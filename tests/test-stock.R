...
ok(ut_cmp_identical(
    ...
    array(c(10.5), dim = c(1))), "stock_a__midlen")
ok(ut_cmp_identical(
...
ok(ut_cmp_identical(
    ...
    array(c(50.5, 51.5, 52.5, 53.5, 54.5), dim = c(5))), "stock_b__midlen")
ok(ut_cmp_identical(
...
ok(ut_cmp_equal(
    ...
    array(c(5.000, 55.000, 550.000, 1166.66666666667), dim = c(4))), "stock_wonky__midlen")
ok(ut_cmp_equal(
    environment(model_fn)$model_report$stock_wonky__dl,
    c(10.0000, 90.0000, 900.0000, 333.3333333333333)), "stock_wonky__dl")
