...
ok_group('print.g3_r', {
    ...
    ok(ut_cmp_identical(cap(print(model_fn)), c(
        ...
        "        param$value[param$logarithmic] <- lapply(param[param$logarithmic, ",
        "            \"value\"], log)",
        "        param_lower[param$logarithmic] <- lapply(param_lower[param$logarithmic], ",
        "            log)",
        "        param_upper[param$logarithmic] <- lapply(param_upper[param$logarithmic], ",
        "            log)",
