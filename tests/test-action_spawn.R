...
ok_group('g3a_spawn', {
    ...
    params$lingimm.init <- 0
    params$lingimm.init.scalar <- 0
    ...
    params$spawn.prop.alpha <- 0.5
    params$spawn.prop.l50 <- 120
    params$spawn.mort.alpha <- 0
    params$spawn.mort.beta <- 0
