...
ok(ut_cmp_equal(as.vector(g3_array_agg(r$dstart_pred_a__num, c("time"))), as.vector(c(
    ...
    `2005-01` = 0, `2005-02` = 0,
    NULL )), tolerance = 6e-6), "dstart_pred_a__num: Fished to extinction, remains finite")
ok(ut_cmp_equal(as.vector(g3_array_agg(r$dstart_pred_a__wgt, c("time"))), as.vector(c(
