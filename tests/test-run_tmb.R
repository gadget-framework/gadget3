...
ok_group('g3_tmb_par', {
    ...
    pt <- attr(g3_to_tmb(list(~g3_param('x', value = 15, lower = 10, upper = 25, logarithmic = TRUE))), 'parameter_template')
...
ok_group('g3_tmb_parscale', {
    ...
    pt <- attr(g3_to_tmb(list(~g3_param('x', value = 15, lower = 10, upper = 25, parscale = 44, logarithmic = TRUE))), 'parameter_template')
...
# g3_param(logarithmic = TRUE)
actions <- c(actions, g3_formula({
    comment("g3_param(logarithmic = TRUE)")
    g3_param_log_out <- g3_param("param_log", logarithmic = TRUE)
