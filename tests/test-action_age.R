...
ok_group("age", {
    ...
    ok(ut_cmp_identical(as.vector(r$step1_prey_c__num), c(0, 0, 30, 0, 0, 0, 0)), "step1_prey_c__num: Final age of prey_b transferred")
    ok(ut_cmp_identical(as.vector(r$step1_prey_c__wgt), c(0, 0, 300, 0, 0, 0, 0)), "step1_prey_c__wgt: Final weight of prey_b transferred")
    ...
    ok(ut_cmp_identical(as.vector(r$step2_prey_c__num), c(0, 0, 30, 0, 0, 0, 0)), "step2_prey_c__num: Not final step, nothing changed")
    ok(ut_cmp_identical(as.vector(r$step2_prey_c__wgt), c(0, 0, 300, 0, 0, 0, 0)), "step2_prey_c__wgt: Not final step, nothing changed")
    ...
    ok(ut_cmp_identical(as.vector(r$step3_prey_c__num), c(0, 0, 20, 30, 0, 0, 0)), "step3_prey_c__num: Final age of prey_b transferred, numbers rotated")
    ok(ut_cmp_identical(as.vector(r$step3_prey_c__wgt), c(0, 0, 200, 300, 0, 0, 0)), "step3_prey_c__wgt: Final age of prey_b transferred")
